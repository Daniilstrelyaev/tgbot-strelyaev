...
# Приветствие ОБЩЕЕ (без названия конкретного гайда), т.к. оно одно для всех
# кодовых слов. Сам материал (свой для каждого кода) приходит после подписки.
WELCOME_TEXT = (
    "Привет! 👋\n\n"
    ...
    "🎁 Я подготовил для тебя бесплатный материал — забери его ниже.\n\n"
    "👇 Чтобы получить — <b>подпишись на канал</b> и нажми кнопку."
)
...
LEAD_MAGNETS: dict[str, dict[str, str]] = {
    ...
    # КОМАНДА (Instagram-слово «команда») — гайд «Нейро-команда для блога»
    "komanda": {
        "file_id": "BQACAgIAAyEGAATeHwufAAMbaiLSzmSYRdMhPUzn4-C3amrZnskAAsidAALHLRFJJ2OHb2gzS0A7BA",
        "caption": (
            "Держи гайд <b>«Нейро-команда для блога»</b> 🤖\n\n"
            "Внутри — как собрать команду нейросетей, которая ведёт блог "
            "за тебя: идеи, сценарии, монтаж, тексты.\n\n"
            "Когда захочешь разобрать свой блог лично — "
            "напиши мне слово <b>РАЗБОР</b> 🔥"
        ),
    },

    # ЖИВОЙ (Instagram-слово «живой») — гайд «Как сделать AI-контент, который не палится»
    "zhivoy": {
        "file_id": "BQACAgIAAyEGAATeHwufAAMcaiVvv8OX_QUVSs4r8a48t5Y4-dEAAj2nAAIjBTBJgfI3okIx5XY7BA",
        "caption": (
            "Держи гайд <b>«Как сделать AI-контент, который не палится»</b> 🎭\n\n"
            "Внутри — приёмы, чтобы нейро-контент выглядел живым "
            "и естественным, а не «сделанным ИИ».\n\n"
            "Когда захочешь разобрать свой контент лично — "
            "напиши мне слово <b>РАЗБОР</b> 🔥"
        ),
    },
}
